...
No-share variant: share_tokens=0 with seq_gen="NOadd", objective="G2DYDTSP",
...
class TrainingManager:
    ...
    def wait_for_gpus(self, needed_gpus):
        ...
        while True:
            ...
            print("Not enough GPUs available. Waiting 300 seconds...")
            time.sleep(300)
...
def main():
    ...
    # Sweep: the no-share variant (share_tokens=0 -> NOadd) over the paper's learning rates.
    param_grid = [
        {
            "objective": ["G2DYDTSP"],
            "bin": ["bin10_exp1_th10"],
